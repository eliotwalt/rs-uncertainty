...
options="-n 1 --mem-per-cpu=72000 --time=75:00:00 --job-name=train_all --output=$log_f --error=$log_f --gpus=1 --gres=gpumem:48g" # time: h/epoch ~ 0.2875h, safety: 0.4h, RAM max ~21.76Gb => 23Gb
